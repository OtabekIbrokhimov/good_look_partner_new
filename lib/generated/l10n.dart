...
class S {
  ...
  /// `Master's allowance`
  String get mastersAllowance {
    return Intl.message(
      'Master\'s allowance',
      name: 'mastersAllowance',
      desc: '',
      args: [],
    );
  }
  ...
  String get pROBUSINESSaccount {
    return Intl.message(
      'PRO BUSINESS account',
      name: 'pROBUSINESSaccount',
      desc: '',
      args: [],
    );
  }

  /// `Select from PRO JOB entries`
  String get selectPROJOBentries {
    return Intl.message(
      'Select from PRO JOB entries',
      name: 'selectPROJOBentries',
      desc: '',
      args: [],
    );
  }

  /// `Select PRO BUSINESS account`
  String get selectPROBUSINESSaccount {
    return Intl.message(
      'Select PRO BUSINESS account',
      name: 'selectPROBUSINESSaccount',
      desc: '',
      args: [],
    );
  }

  /// `Add an entry to PRO JOB`
  String get addEntryToPROJOB {
    return Intl.message(
      'Add an entry to PRO JOB',
      name: 'addEntryToPROJOB',
      desc: '',
      args: [],
    );
  }
  ...
  String get createPROBUSINESSaccount {
    return Intl.message(
      'Create a PRO BUSINESS account',
      name: 'createPROBUSINESSaccount',
      desc: '',
      args: [],
    );
  }
